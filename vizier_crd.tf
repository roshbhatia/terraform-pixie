                    ...
                    "dataCollectorParams" = {
                      ...
                      "properties" = {
                        ...
                        "tableStoreTableSizeLimit" = {
                          "description" = "TableStoreTableSizeLimit is the maximum allowed size for a table in the table store. When the size grows beyond this limit, old data will be discarded."
                          "format"      = "int32"
                          "type"        = "integer"
                        }
                      }
